...
#Creating the window
wn = Tk()
wn.title('QR Code Generator For Any Tipe Of Real Time Websites')
wn.geometry('700x700')
wn.config(bg='red')
...
lable1 = Label(Frame1,text="Enter the text/URL: ",bg="red",fg='azure',font=('Courier',13,'bold'))
...
lable2 = Label(Frame2,text="Enter the location to save the QR Code: ",bg="red",fg='azure',font=('Courier',13,'bold'))
...
lable3 = Label(Frame3,text="Enter the name of the QR Code: ",bg="red",fg='azure',font=('Courier',13,'bold'))
...
lable4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 being 21x21: ",bg="red",fg='azure',font=('Courier',13,'bold'))
